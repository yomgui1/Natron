...
TOPSRC ?= $(NATRON_SRC_DIR)/Natron-Deps
TOPDST ?= $(PWD)
SRC := $(TOPSRC)/src
...
CXXFLAGS := $(CXXFLAGS) $(EXTRA_CFLAGS) $(EXTRA_CXXFLAGS) -g -std=c++14
...
# libtool stuff:
HOSTCONF += --disable-static --enable-shared
# HOSTCONF EXTRA FOR BUILD MACHINE ONLY: --disable-dependency-tracking
ifdef HAVE_WIN32
...
ifeq ($(V),1)
CMAKE += -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DVERBOSE=1
endif
