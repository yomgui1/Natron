...
BOOST_CLASS_VERSION(Natron::KnobSerialization, KNOB_SERIALIZATION_VERSION)
BOOST_CLASS_VERSION(Natron::ValueSerialization, VALUE_SERIALIZATION_VERSION)
BOOST_CLASS_VERSION(Natron::MasterSerialization, MASTER_SERIALIZATION_VERSION)
