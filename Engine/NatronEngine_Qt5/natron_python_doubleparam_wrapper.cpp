...
{
    DoubleParamWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<DoubleParamWrapper *>(reinterpret_cast< ::Natron::Python::DoubleParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_DOUBLEPARAM_IDX], reinterpret_cast<SbkObject *>(self))));
    PyObject* pyResult{};
    int overloadId = -1;
    ...
    // 0: DoubleParam::addAsDependencyOf(Natron::Python::Param*,int,int,QString,QString)
    if (numArgs == 5
...
static PyObject* Sbk_Natron_Python_DoubleParamFunc_get(PyObject* self, PyObject* args, PyObject* kwds)
{
    DoubleParamWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    if (numArgs + numNamedArgs > 2) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.get(): too many arguments");
        return {};
    }
    ...
    switch (overloadId) {
        case 0: // get(const QString & view) const
        {
            if (kwds) {
                ...
                if (value && pyArgs[0]) {
                    PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.get(): got multiple values for keyword argument 'view'.");
                    return {};
                } else if (value) {
                    pyArgs[0] = value;
                    if (!(pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[0]))))
                        goto Sbk_Natron_Python_DoubleParamFunc_get_TypeError;
                }
            }
        ...
        case 1: // get(double frame, const QString & view) const
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                double cppResult = const_cast<const ::DoubleParamWrapper*>(cppSelf)->get(cppArg0, cppArg1);
                pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<double>(), &cppResult);
            }
            break;
        }
...
static PyObject* Sbk_Natron_Python_DoubleParamFunc_getValue(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // Overloaded function decisor
    // 0: DoubleParam::getValue(int,QString)const
    if (numArgs == 0) {
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[1]) {
                PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.getValue(): got multiple values for keyword argument 'view'.");
                return {};
            } else if (value) {
                pyArgs[1] = value;
                if (!(pythonToCpp[1] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[1]))))
        ...
        if (!PyErr_Occurred()) {
            ...
            double cppResult = const_cast<const ::DoubleParamWrapper*>(cppSelf)->getValue(cppArg0, cppArg1);
            pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<double>(), &cppResult);
        }
    }
...
static PyObject* Sbk_Natron_Python_DoubleParamFunc_getValueAtTime(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // Overloaded function decisor
    // 0: DoubleParam::getValueAtTime(double,int,QString)const
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            value = PyDict_GetItemString(kwds, "view");
            if (value && pyArgs[2]) {
                PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.getValueAtTime(): got multiple values for keyword argument 'view'.");
                return {};
            } else if (value) {
                pyArgs[2] = value;
        ...
        if (!PyErr_Occurred()) {
            ...
            double cppResult = const_cast<const ::DoubleParamWrapper*>(cppSelf)->getValueAtTime(cppArg0, cppArg1, cppArg2);
            pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<double>(), &cppResult);
        }
    }
...
static PyObject* Sbk_Natron_Python_DoubleParamFunc_restoreDefaultValue(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // Overloaded function decisor
    // 0: DoubleParam::restoreDefaultValue(int,QString)
    if (numArgs == 0) {
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            value = PyDict_GetItemString(kwds, "view");
            if (value && pyArgs[1]) {
                PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.restoreDefaultValue(): got multiple values for keyword argument 'view'.");
                return {};
            } else if (value) {
                pyArgs[1] = value;
                if (!(pythonToCpp[1] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[1]))))
...
static PyObject* Sbk_Natron_Python_DoubleParamFunc_set(PyObject* self, PyObject* args, PyObject* kwds)
{
    DoubleParamWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // invalid argument lengths
    if (numArgs + numNamedArgs > 3) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.set(): too many arguments");
        return {};
    } else if (numArgs < 1) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.set(): not enough arguments");
        return {};
    }
    ...
    // Overloaded function decisor
    // 0: DoubleParam::set(double,QString)
    // 1: DoubleParam::set(double,double,QString)
    if ((pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<double>(), (pyArgs[0])))) {
        if (numArgs == 1) {
            overloadId = 0; // set(double,QString)
            ...
            if (numArgs == 2) {
                overloadId = 1; // set(double,double,QString)
            } else if ((pythonToCpp[2] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[2])))) {
                overloadId = 1; // set(double,double,QString)
            }
        } else if ((pythonToCpp[1] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[1])))) {
    ...
    // Call function/method
    switch (overloadId) {
        case 0: // set(double x, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[1]) {
                    ...
                    pyArgs[1] = value;
                    if (!(pythonToCpp[1] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[1]))))
                        goto Sbk_Natron_Python_DoubleParamFunc_set_TypeError;
                }
            }
            double cppArg0;
            pythonToCpp[0](pyArgs[0], &cppArg0);
        ...
        case 1: // set(double x, double frame, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[2]) {
...
static PyObject* Sbk_Natron_Python_DoubleParamFunc_setValue(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // Overloaded function decisor
    // 0: DoubleParam::setValue(double,int,QString)
    if ((pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<double>(), (pyArgs[0])))) {
        if (numArgs == 1) {
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            value = PyDict_GetItemString(kwds, "view");
            if (value && pyArgs[2]) {
                PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.setValue(): got multiple values for keyword argument 'view'.");
                return {};
            } else if (value) {
                pyArgs[2] = value;
                if (!(pythonToCpp[2] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[2]))))
...
static PyObject* Sbk_Natron_Python_DoubleParamFunc_setValueAtTime(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // Overloaded function decisor
    // 0: DoubleParam::setValueAtTime(double,double,int,QString)
    if (numArgs >= 2
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            value = PyDict_GetItemString(kwds, "view");
            if (value && pyArgs[3]) {
                PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.DoubleParam.setValueAtTime(): got multiple values for keyword argument 'view'.");
                return {};
            } else if (value) {
                pyArgs[3] = value;
...
static PyMethodDef Sbk_Natron_Python_DoubleParam_methods[] = {
    ...
    {"get", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_DoubleParamFunc_get), METH_VARARGS|METH_KEYWORDS},
    ...
    {"set", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_DoubleParamFunc_set), METH_VARARGS|METH_KEYWORDS},
...
static PyType_Spec Sbk_Natron_Python_DoubleParam_spec = {
    "NatronEngine.Natron.Python.DoubleParam",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_DoubleParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.DoubleParam.addAsDependencyOf(param:NatronEngine.Natron.Python.Param,fromExprDimension:int,thisDimension:int,fromExprView:QString,thisView:QString)->double",
    "1:NatronEngine.Natron.Python.DoubleParam.get(view:QString=QLatin1String(kPyParamViewIdxMain))->double",
    "0:NatronEngine.Natron.Python.DoubleParam.get(frame:double,view:QString=QLatin1String(kPyParamViewIdxMain))->double",
    ...
    "NatronEngine.Natron.Python.DoubleParam.getValue(dimension:int=0,view:QString=QLatin1String(kPyParamViewIdxMain))->double",
    "NatronEngine.Natron.Python.DoubleParam.getValueAtTime(time:double,dimension:int=0,view:QString=QLatin1String(kPyParamViewIdxMain))->double",
    "NatronEngine.Natron.Python.DoubleParam.restoreDefaultValue(dimension:int=-1,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "1:NatronEngine.Natron.Python.DoubleParam.set(x:double,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "0:NatronEngine.Natron.Python.DoubleParam.set(x:double,frame:double,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    ...
    "NatronEngine.Natron.Python.DoubleParam.setValue(value:double,dimension:int=0,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "NatronEngine.Natron.Python.DoubleParam.setValueAtTime(value:double,time:double,dimension:int=0,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    nullptr}; // Sentinel
