...
class PyCornerPinOverlayInteractWrapper : public Natron::Python::PyCornerPinOverlayInteract
{
public:
    ...
    inline Natron::Python::Param * fetchParameter_protected(const std::map<QString,QString > & params, const QString & role, const QString & type, int nDims, bool optional) const { return Natron::Python::PyCornerPinOverlayInteract::fetchParameter(params, role, type, nDims, optional); }
    ...
    inline void initInternalInteract_protected() { Natron::Python::PyCornerPinOverlayInteract::initInternalInteract(); }
