...
extern "C" {
static PyObject* Sbk_Natron_Python_Int2DParamFunc_get(PyObject* self, PyObject* args, PyObject* kwds)
{
    Int2DParamWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<Int2DParamWrapper *>(reinterpret_cast< ::Natron::Python::Int2DParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INT2DPARAM_IDX], reinterpret_cast<SbkObject *>(self))));
    PyObject* pyResult{};
    int overloadId = -1;
    ...
    if (numArgs + numNamedArgs > 2) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Int2DParam.get(): too many arguments");
        return {};
    }
    ...
    switch (overloadId) {
        case 0: // get(const QString & view) const
        {
            if (kwds) {
                ...
                if (value && pyArgs[0]) {
                    PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Int2DParam.get(): got multiple values for keyword argument 'view'.");
                    return {};
                } else if (value) {
                    pyArgs[0] = value;
                    if (!(pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[0]))))
                        goto Sbk_Natron_Python_Int2DParamFunc_get_TypeError;
                }
            }
            ...
            if (!PyErr_Occurred()) {
                // get(QString)const
                Natron::Python::Int2DTuple* cppResult = new Natron::Python::Int2DTuple(const_cast<const ::Int2DParamWrapper*>(cppSelf)->get(cppArg0));
        ...
        case 1: // get(double frame, const QString & view) const
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                Natron::Python::Int2DTuple* cppResult = new Natron::Python::Int2DTuple(const_cast<const ::Int2DParamWrapper*>(cppSelf)->get(cppArg0, cppArg1));
                pyResult = Shiboken::Object::newObject(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INT2DTUPLE_IDX]), cppResult, true, true);
            }
            break;
        }
...
static PyObject* Sbk_Natron_Python_Int2DParamFunc_set(PyObject* self, PyObject* args, PyObject* kwds)
{
    Int2DParamWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    if (numArgs + numNamedArgs > 4) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Int2DParam.set(): too many arguments");
        return {};
    } else if (numArgs < 1) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Int2DParam.set(): not enough arguments");
        return {};
    }
    ...
    // Overloaded function decisor
    // 0: Int2DParam::set(int,int,QString)
    // 1: IntParam::set(int,QString)
    // 2: Int2DParam::set(int,int,double,QString)
    if ((pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<int>(), (pyArgs[0])))) {
        if (numArgs == 1) {
            ...
            if (numArgs == 2) {
                overloadId = 0; // set(int,int,QString)
                ...
                if (numArgs == 3) {
                    overloadId = 2; // set(int,int,double,QString)
    ...
    // Call function/method
    switch (overloadId) {
        case 0: // set(int x, int y, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[2]) {
                    ...
                    if (!(pythonToCpp[2] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[2]))))
                        goto Sbk_Natron_Python_Int2DParamFunc_set_TypeError;
                }
            }
            int cppArg0;
            pythonToCpp[0](pyArgs[0], &cppArg0);
        ...
        case 2: // set(int x, int y, double frame, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[3]) {
...
static PyMethodDef Sbk_Natron_Python_Int2DParam_methods[] = {
    {"get", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_Int2DParamFunc_get), METH_VARARGS|METH_KEYWORDS},
    {"set", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_Int2DParamFunc_set), METH_VARARGS|METH_KEYWORDS},
...
static PyType_Spec Sbk_Natron_Python_Int2DParam_spec = {
    "NatronEngine.Natron.Python.Int2DParam",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_Int2DParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.Int2DParam.get(view:QString=QLatin1String(kPyParamViewIdxMain))->NatronEngine.Natron.Python.Int2DTuple",
    "0:NatronEngine.Natron.Python.Int2DParam.get(frame:double,view:QString=QLatin1String(kPyParamViewIdxMain))->NatronEngine.Natron.Python.Int2DTuple",
    "2:NatronEngine.Natron.Python.Int2DParam.set(x:int,y:int,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "1:NatronEngine.Natron.Python.Int2DParam.set(x:int,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "0:NatronEngine.Natron.Python.Int2DParam.set(x:int,y:int,frame:double,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    nullptr}; // Sentinel
