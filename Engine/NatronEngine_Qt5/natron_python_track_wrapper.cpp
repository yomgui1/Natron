...
{
    ::Natron::Python::Track* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = reinterpret_cast< ::Natron::Python::Track *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_TRACK_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Spec Sbk_Natron_Python_Track_spec = {
    "NatronEngine.Natron.Python.Track",
    sizeof(SbkObject),
    0,
...
static void* Sbk_Natron_Python_Track_typeDiscovery(void* cptr, SbkObjectType* instanceType)
{
    if (instanceType == reinterpret_cast<SbkObjectType*>(Shiboken::SbkType< ::Natron::Python::ItemBase >()))
        return dynamic_cast< ::Natron::Python::Track*>(reinterpret_cast< ::Natron::Python::ItemBase*>(cptr));
    return {};
}
...
static const char *Natron_Python_Track_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Track.reset()",
    nullptr}; // Sentinel
...
void init_Natron_Python_Track(PyObject* module)
{
    _Sbk_Natron_Python_Track_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        Natron_Python_Track_SignatureStrings,
    ...
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(Sbk_Natron_Python_Track_TypeF(), &Sbk_Natron_Python_Track_typeDiscovery);
