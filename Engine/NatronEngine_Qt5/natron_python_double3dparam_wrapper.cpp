...
extern "C" {
static PyObject* Sbk_Natron_Python_Double3DParamFunc_get(PyObject* self, PyObject* args, PyObject* kwds)
{
    Double3DParamWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<Double3DParamWrapper *>(reinterpret_cast< ::Natron::Python::Double3DParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_DOUBLE3DPARAM_IDX], reinterpret_cast<SbkObject *>(self))));
    PyObject* pyResult{};
    int overloadId = -1;
    ...
    if (numArgs + numNamedArgs > 2) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Double3DParam.get(): too many arguments");
        return {};
    }
    ...
    switch (overloadId) {
        case 0: // get(const QString & view) const
        {
            if (kwds) {
                ...
                if (value && pyArgs[0]) {
                    PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Double3DParam.get(): got multiple values for keyword argument 'view'.");
                    return {};
                } else if (value) {
                    pyArgs[0] = value;
                    if (!(pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[0]))))
                        goto Sbk_Natron_Python_Double3DParamFunc_get_TypeError;
                }
            }
            ...
            if (!PyErr_Occurred()) {
                // get(QString)const
                Natron::Python::Double3DTuple* cppResult = new Natron::Python::Double3DTuple(const_cast<const ::Double3DParamWrapper*>(cppSelf)->get(cppArg0));
        ...
        case 1: // get(double frame, const QString & view) const
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                Natron::Python::Double3DTuple* cppResult = new Natron::Python::Double3DTuple(const_cast<const ::Double3DParamWrapper*>(cppSelf)->get(cppArg0, cppArg1));
                pyResult = Shiboken::Object::newObject(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_PYTHON_DOUBLE3DTUPLE_IDX]), cppResult, true, true);
            }
            break;
        }
...
static PyObject* Sbk_Natron_Python_Double3DParamFunc_set(PyObject* self, PyObject* args, PyObject* kwds)
{
    Double3DParamWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    if (numArgs + numNamedArgs > 5) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Double3DParam.set(): too many arguments");
        return {};
    } else if (numArgs < 1) {
        PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Double3DParam.set(): not enough arguments");
        return {};
    }
    ...
    // Overloaded function decisor
    // 0: Double2DParam::set(double,double,double,QString)
    // 1: DoubleParam::set(double,double,QString)
    // 2: DoubleParam::set(double,QString)
    // 3: Double3DParam::set(double,double,double,double,QString)
    if ((pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<double>(), (pyArgs[0])))) {
        if (numArgs == 1) {
            overloadId = 2; // set(double,QString)
        } else if ((pythonToCpp[1] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[1])))) {
            overloadId = 2; // set(double,QString)
            ...
            if (numArgs == 2) {
                ...
                if (numArgs == 3) {
                    overloadId = 0; // set(double,double,double,QString)
                    ...
                    if (numArgs == 4) {
                        overloadId = 3; // set(double,double,double,double,QString)
    ...
    // Call function/method
    switch (overloadId) {
        case 0: // set(double x, double y, double z, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[3]) {
                    PyErr_SetString(PyExc_TypeError, "NatronEngine.Natron.Python.Double3DParam.set(): got multiple values for keyword argument 'view'.");
                    return {};
                } else if (value) {
                    pyArgs[3] = value;
                    if (!(pythonToCpp[3] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[3]))))
                        goto Sbk_Natron_Python_Double3DParamFunc_set_TypeError;
                }
            }
            double cppArg0;
            pythonToCpp[0](pyArgs[0], &cppArg0);
        ...
        case 1: // set(double x, double y, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[2]) {
            ...
            if (!PyErr_Occurred()) {
                ...
                reinterpret_cast<Natron::Python::Double2DParam *>(cppSelf)->set(cppArg0, cppArg1, cppArg2);
            }
            break;
        }
        case 2: // set(double x, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[1]) {
        ...
        case 3: // set(double x, double y, double z, double frame, const QString & view)
        {
            if (kwds) {
                PyObject* value = PyDict_GetItemString(kwds, "view");
                if (value && pyArgs[4]) {
...
static PyMethodDef Sbk_Natron_Python_Double3DParam_methods[] = {
    {"get", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_Double3DParamFunc_get), METH_VARARGS|METH_KEYWORDS},
    {"set", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_Double3DParamFunc_set), METH_VARARGS|METH_KEYWORDS},
...
static PyType_Spec Sbk_Natron_Python_Double3DParam_spec = {
    "NatronEngine.Natron.Python.Double3DParam",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_Double3DParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.Double3DParam.get(view:QString=QLatin1String(kPyParamViewIdxMain))->NatronEngine.Natron.Python.Double3DTuple",
    "0:NatronEngine.Natron.Python.Double3DParam.get(frame:double,view:QString=QLatin1String(kPyParamViewIdxMain))->NatronEngine.Natron.Python.Double3DTuple",
    "3:NatronEngine.Natron.Python.Double3DParam.set(x:double,y:double,z:double,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "2:NatronEngine.Natron.Python.Double3DParam.set(x:double,y:double,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "1:NatronEngine.Natron.Python.Double3DParam.set(x:double,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    "0:NatronEngine.Natron.Python.Double3DParam.set(x:double,y:double,z:double,frame:double,view:QString=QLatin1String(kPyParamViewSetSpecAll))",
    nullptr}; // Sentinel
