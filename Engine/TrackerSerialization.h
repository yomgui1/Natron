...
BOOST_CLASS_VERSION(Natron::TrackSerialization, TRACK_SERIALIZATION_VERSION)
BOOST_CLASS_VERSION(Natron::TrackerContextSerialization, TRACKER_CONTEXT_SERIALIZATION_VERSION)
