...
#sed -e 's@Natron::StandardButton@g' -e 's@"NatronGui\.NATRON_NAMESPACE@"NatronGui.Natron@g' -i'.bak' Engine/NatronEngine/natron_wrapper.cpp
...
# remove NATRON_PYTHON_NAMESPACE_EXIT NATRON_NAMESPACE_EXIT missplaced before in natronengine_python.h
#sed -e '/NATRON_PYTHON_NAMESPACE_EXIT NATRON_NAMESPACE_EXIT/d' -i'.bak' Engine/NatronEngine/natronengine_python.h

# replace NATRON_NAMESPACE::NATRON_NAMESPACE with NATRON_NAMESPACE in the enums wrappers
#sed -e 's@NATRON_NAMESPACE::NATRON_PYTHON_NAMESPACE::NATRON_NAMESPACE@NATRON_NAMESPACE@g' -i'.bak' Engine/NatronE#ngine/natronengine_python.h ##Gui/NatronGui/natrongui_python.h
...
CLANG_DIAG_ON(keyword-macro)@' -i'.bak' Engine/NatronEngine/*.cpp Engine/NatronEngine/*.h Gui/NatronGui/*.cpp Gui/NatronGui/*.h
...
# clean up
rm Engine/NatronEngine/*.bak Gui/NatronGui/*.bak
