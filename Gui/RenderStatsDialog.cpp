                     ...
                     const NodeRenderStats& stats)
    {
...

        {
            ...
            if (exists) {
                ...
                QString tt = Natron::convertFromPlainText(tr("The label of the node as it appears on the nodegraph."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
...

        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The ID of the plug-in embedded in the node."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
...

        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The time spent rendering by this node across all threads."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                timeSoFar = stats.getTotalTimeSpentRendering();
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("Whether this node has tiles (portions of the final image) support or not."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("Whether this node has render scale support or not.\n"
                                                               "When activated, that means the node can render an image at a "
                                                               "lower scale."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The mipmaplevel rendered (See render-scale). 0 means scale = 100%, "
                                                               "1 means scale = 50%, 2 means scale = 25%, etc."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The channels processed by this node (corresponding to the RGBA checkboxes)."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The alpha premultiplication of the image produced by this node."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The region of definition of the image produced."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("When different of \"-\", this node does not render but rather "
                                                               "directly returns the image produced by the node indicated by its label."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The list of the tiles that were identity in the image.\n"
                                                               "Double-click for more info."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The list of the tiles effectivly rendered.\n"
                                                               "Double-click for more infos"), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The list of the planes rendered by this node."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The number of cache hits."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The number of cache access hits but at higher scale "
                                                               "hence requiring downscaling."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
        ...
        }
        {
            ...
            if (exists) {
                ...
                item = new TableItem;
                QString tt = Natron::convertFromPlainText(tr("The number of cache misses."), Natron::WhiteSpaceNormal);
                item->setToolTip(tt);
                item->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
            }
            assert(item);
    ...
    , _imp( new RenderStatsDialogPrivate(gui) )
{
    ...
    QString accTt = Natron::convertFromPlainText(tr("When checked, stats are not cleared between the computation of frames."), Natron::WhiteSpaceNormal);
    ...
    QString adTt = Natron::convertFromPlainText(tr("When checked, more statistics are displayed. Useful mainly for debugging purposes."), Natron::WhiteSpaceNormal);
    ...
    QString nameFilterTt = Natron::convertFromPlainText(tr("If unix wildcards are enabled, show only nodes "
                                                             ...
                                                             "show only nodes with a label containing the text in the filter."), Natron::WhiteSpaceNormal);
    ...
    QString idFilterTt = Natron::convertFromPlainText(tr("If unix wildcards are enabled, show only nodes "
                                                           ...
                                                           "show only nodes with a plugin ID containing the text in the filter."), Natron::WhiteSpaceNormal);
