    ...
    , _imp( new ExportGroupTemplateDialogPrivate(group, gui) )
{
    ...
    QString idTt = Natron::convertFromPlainText(tr("The unique ID is used by %1 to identify the plug-in in various "
                                                     ...
                                                     " search-paths will take precedence over the other.").arg( QString::fromUtf8(NATRON_APPLICATION_NAME) ), Natron::WhiteSpaceNormal);
    ...
    QString labelTt = Natron::convertFromPlainText(tr("Set the label of the group as the user will see it in the user interface."), Natron::WhiteSpaceNormal);
    ...
    QString groupingTt = Natron::convertFromPlainText(tr("The grouping of the plug-in specifies where the plug-in will be located in the menus, "
                                                           "e.g. \"Color/Transform\", or \"Draw\". Each sub-level must be separated by a '/'."), Natron::WhiteSpaceNormal);
    ...
    QString versionTt = Natron::convertFromPlainText(tr("The version can be incremented when changing the behaviour of the plug-in. "
                                                          ...
                                                          "the plug-in should update to the newer version in the project or not."), Natron::WhiteSpaceNormal);
    ...
    QString iconTt = Natron::convertFromPlainText(tr("Set here the file path of an optional icon to identify the plug-in. "
                                                       "The path is relative to the Python script."), Natron::WhiteSpaceNormal);
    ...
    QString descTt =  Natron::convertFromPlainText(tr("Set here the (optional) plug-in description that the user will see when clicking the "
                                                        "\"?\" button on the settings panel of the node."), Natron::WhiteSpaceNormal);
    ...
    QString fileTt  = Natron::convertFromPlainText(tr("Specify here the directory where to export the Python script."), Natron::WhiteSpaceNormal);
